        ...
        <div class="scanner-card">
            ...
            <div v-else class="placeholder-box">
                <i
                    ...
                    style="font-size: 2rem; margin-bottom: 10px; color: #94a3b8"
                ></i>
        ...
        >
            <div class="confirmation-content" v-if="studentDetails">
                <div class="student-avatar">
                    <img
                        v-if="studentDetails.profile_url"
                        :src="studentDetails.profile_url"
                        alt="Student"
                    />
                ...
                <div class="student-details-grid">
                    ...
                    <div
                        ...
                        v-if="currentParticipationStatus === 'active'"
                    >
            ...
            <template #footer>
                <div class="dialog-actions">
                    ...
                    <Button
                        v-if="
                            currentParticipationStatus === 'none' ||
                            currentParticipationStatus === 'not_found'
                        "
...
const modalHeader = computed(() => {
    if (currentParticipationStatus.value === "active")
        return "Confirm Time Out";
    if (currentParticipationStatus.value === "completed")
...
const prepareConfirmation = async (studentId) => {
    ...
    try {
        // Get Student Info and Participation Status
...
const executeAction = async () => {
    ...
    // Capture details before clearing variables
    const dbId = studentDetails.value.id;
    const name = studentDetails.value.name; 
    const schoolId = scannedStudentId.value; 
