<template>
    <div class="view-panel">
        ...
        <div class="table-container">
            ...
            >
                <template #empty
                    ><div class="empty-msg">No records found.</div></template
                >
                ...
                <Column field="student_name" header="Student" class="font-bold">
                    <template #body="slotProps">
                        ...
                        <span class="sub-text">
                            ({{ slotProps.data.student_school_id }})</span
                        >
                    </template>
                </Column>
                ...
                <Column header="Time Out" field="time_out">
                    <template #body="slotProps">
                        ...
                        <template v-else>
                            ...
                            <span v-else class="status-tag ongoing">
                                Ongoing
                            </span>
                        </template>
                    </template>
        ...
        <div class="pagination-footer">
            <span class="page-info">
                Showing {{ participation.length }} records on Page
                {{ currentPage }}
            </span>
                    ...
                    >
                        <template #option="slotProps">
                            <div class="autocomplete-item">
                                ...
                                <span class="id"
                                    >({{ slotProps.option.student_id }})</span
                                >
                            </div>
                        </template>
                    </AutoComplete>
...
const searchStudent = (event) => {
    ...
    filteredStudents.value = localStudents.value.filter(
        (s) =>
